...
class Questions: UIViewController {
    ...
    @IBOutlet weak var multipleStakcedView: UIStackView!
    ...
    func updateUI() {
        ...
        multipleStakcedView.isHidden = true
    ...
    func updateMultipleStack(using answers: [Answer]) {
        multipleStakcedView.isHidden = false
   ...
   override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if segue.identifier == "resultsSegue" {
            let resultsViewController = segue.destination as! Results
